...
func deserializeStatsEntry(stat interface{}) (entryOutput *statsEntryOutput, err error) {
	...
	entryOutput = &statsEntryOutput{
		...
		ninetyFivePercentageResponseTime: get95PercentResponseTime(entry.ResponseTimes),
		ninetyNinePercentageResponseTime: get99PercentResponseTime(entry.ResponseTimes),
